...
var CTRL = {
	...
	fillData: function fillData() {
		MODEL.session.data(new Array(MODEL.dimensions.height()).fill(new Array(MODEL.dimensions.height()).fill(MODEL.session.tiles[0])));
	},
...
module.exports = function (dom) {
	...
	var image = createCanvas();
	var image$ = image.getContext("2d");
	var w = dom.width;
	var h = dom.height;
