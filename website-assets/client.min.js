...
var App = {
	...
	view: function view(vnode) {
		return m(".screen", [m("div", {
			class: "settings-toggle " + (MODEL.menuopen() ? "open" : ""),
			onclick: this.menuClick
		}, [m("div.line-1"), m("div.line-2"), m("div.line-3")]), m(Monitor), m(Settings), m(Tools), MODEL.modalopen() ? m(Modal) : ""]);
	}
};

module.exports = App;

},{"../frame.js":5,"./Modal.js":12,"./Monitor.js":13,"./Settings.js":14,"./Tools.js":17,"mithril":2,"mithril-stream":1}],8:[function(require,module,exports){
"use strict";
...
},{"../frame.js":5,"./Canvas.js":8,"mithril":2,"mithril-stream":1}],10:[function(require,module,exports){
"use strict";
...
var Settings = {
	...
	view: function view(vnode) {
		...
		}, [m("div.wrapper", [m("h1", "Settings"), this.fields.map(function (fieldData) {
			return m(that.nodes.Field, fieldData);
		}), this.displayWarning ? m(this.nodes.Warning) : "", m("input", {
			type: "button",
